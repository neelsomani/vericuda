...
Definition prog : list M.stmt :=
  [ M.SAssign "_3" (M.EVar "sha512_oneshot::assert_kernel_parameter_is_copy::<*mut [u8; 64]>()");
    M.SAssign "_4" (M.EVar "sha512_oneshot::assert_kernel_parameter_is_copy::<&[u8]>()");
    M.SAssign "_6" (M.EVar "index_1d()");
    M.SAssign "_5" (M.EVar "_6");
    M.SIf (M.EVar "_5") [] [];
    M.SAssign "_7" (M.EVar "<CoreWrapper<CtVariableCoreWrapper<Sha512VarCore, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B0>, B0>, B0>, B0>, B0>, B0>, OidSha512>> as Digest>::digest::<&[u8]>(copy _1)");
    ...
    M.SAssign "_11" (M.EVar "GenericArray::<u8, UInt<UInt<UInt<UInt<UInt<UInt<UInt<UTerm, B1>, B0>, B0>, B0>, B0>, B0>, B0>>::as_slice(move _12)");
