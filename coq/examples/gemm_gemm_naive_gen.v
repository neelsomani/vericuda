...
Definition prog : list M.stmt :=
  [ M.SAssign "_9" (M.EVar "gemm_naive::assert_kernel_parameter_is_copy::<f32>()");
    M.SAssign "_10" (M.EVar "gemm_naive::assert_kernel_parameter_is_copy::<f32>()");
    M.SAssign "_11" (M.EVar "gemm_naive::assert_kernel_parameter_is_copy::<usize>()");
    M.SAssign "_12" (M.EVar "gemm_naive::assert_kernel_parameter_is_copy::<usize>()");
    M.SAssign "_13" (M.EVar "gemm_naive::assert_kernel_parameter_is_copy::<usize>()");
    M.SAssign "_14" (M.EVar "gemm_naive::assert_kernel_parameter_is_copy::<*mut f32>()");
    M.SAssign "_15" (M.EVar "gemm_naive::assert_kernel_parameter_is_copy::<&[f32]>()");
    M.SAssign "_16" (M.EVar "gemm_naive::assert_kernel_parameter_is_copy::<&[f32]>()");
    M.SAssign "_20" (M.EVar "block_dim_x()");
    M.SAssign "_21" (M.EVar "block_idx_x()");
    M.SAssign "_22" (M.EMul (M.EVar "_20") (M.EVar "_21"));
    M.SAssign "_19" (M.EVar "_22");
    M.SAssign "_23" (M.EVar "thread_idx_x()");
    M.SAssign "_24" (M.EAdd (M.EVar "_19") (M.EVar "_23"));
    M.SAssign "_18" (M.EVar "_24");
    M.SAssign "_17" (M.EVar "_18");
    M.SAssign "_28" (M.EVar "block_dim_y()");
    M.SAssign "_29" (M.EVar "block_idx_y()");
    M.SAssign "_30" (M.EMul (M.EVar "_28") (M.EVar "_29"));
    M.SAssign "_27" (M.EVar "_30");
    M.SAssign "_31" (M.EVar "thread_idx_y()");
    ...
    M.SIf (M.EVar "_33") [ M.SAssign "_34" (M.ELt (M.EVar "_25") (M.EVar "_5"));
      ...
      M.SAssign "_37" (M.EVar "std::ops::Range::<usize> { start: const 0_usize, end: copy _6 }");
      M.SAssign "_36" (M.EVar "<std::ops::Range<usize> as IntoIterator>::into_iter(move _37)");
      M.SAssign "_38" (M.EVar "_36");
      M.SAssign "_40" (M.EVar "_38");
      M.SAssign "_39" (M.EVar "_40");
      M.SAssign "_41" (M.EVar "_39");
      M.SWhile (M.EVar "_41") [ M.SAssign "_42" (M.EVar "(_39 as Some).0: usize");
      ...
      M.SAssign "_49" (M.EVar "PtrMetadata(copy _1)");
      ...
      M.SAssign "_56" (M.EVar "PtrMetadata(copy _2)");
      ...
      M.SAssign "_59" (M.EVar "std::ptr::mut_ptr::<impl *mut f32>::add(copy _3, move _60)");
