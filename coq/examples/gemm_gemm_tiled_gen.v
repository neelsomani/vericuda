...
Definition prog : list M.stmt :=
  [ M.SAssign "_9" (M.EVal (M.VBool true));
    ...
    M.SAssign "_35" (M.EStepBy (M.EVar "_36") (M.EVal (MC.const_TILE_SIZE)));
    ...
    M.SIf (M.EVar "_126") [ M.SAssign "_127" (M.ELt (M.EVar "_27") (M.EVar "_5"));
      ...
      M.SAssign "_145" (M.EVal (MC.const_ALIGNOF_f32));
      ...
      M.SAssign "_177" (M.EVal (MC.const_SIZEOF_f32));
      ...
      M.SAssign "_139" (M.EVal (MC.const_ALIGNOF_f32));
      ...
      M.SAssign "_184" (M.EVal (MC.const_SIZEOF_f32));
