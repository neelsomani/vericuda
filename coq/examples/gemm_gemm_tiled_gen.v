...
Definition prog : list M.stmt :=
  [ M.SAssign "_9" (M.EVar "gemm_tiled::assert_kernel_parameter_is_copy::<f32>()");
    M.SAssign "_10" (M.EVar "gemm_tiled::assert_kernel_parameter_is_copy::<f32>()");
    M.SAssign "_11" (M.EVar "gemm_tiled::assert_kernel_parameter_is_copy::<usize>()");
    M.SAssign "_12" (M.EVar "gemm_tiled::assert_kernel_parameter_is_copy::<usize>()");
    M.SAssign "_13" (M.EVar "gemm_tiled::assert_kernel_parameter_is_copy::<usize>()");
    M.SAssign "_14" (M.EVar "gemm_tiled::assert_kernel_parameter_is_copy::<*mut f32>()");
    M.SAssign "_15" (M.EVar "gemm_tiled::assert_kernel_parameter_is_copy::<&[f32]>()");
    M.SAssign "_16" (M.EVar "gemm_tiled::assert_kernel_parameter_is_copy::<&[f32]>()");
    M.SAssign "_18" (M.EVar "thread_idx_x()");
    M.SAssign "_17" (M.EVar "_18");
    M.SAssign "_20" (M.EVar "thread_idx_y()");
    M.SAssign "_19" (M.EVar "_20");
    M.SAssign "_24" (M.EVar "block_idx_x()");
    ...
    M.SAssign "_30" (M.EVar "block_idx_y()");
    ...
    M.SAssign "_36" (M.EVar "std::ops::Range::<usize> { start: const 0_usize, end: copy _6 }");
    M.SAssign "_35" (M.EVar "<std::ops::Range<usize> as Iterator>::step_by(move _36, const TILE_SIZE)");
    M.SAssign "_34" (M.EVar "<StepBy<std::ops::Range<usize>> as IntoIterator>::into_iter(move _35)");
    M.SAssign "_37" (M.EVar "_34");
    M.SAssign "_39" (M.EVar "_37");
    M.SAssign "_38" (M.EVar "_39");
    M.SAssign "_40" (M.EVar "_38");
    M.SWhile (M.EVar "_40") [ M.SAssign "_41" (M.EVar "(_38 as Some).0: usize");
    ...
    M.SIf (M.EVar "_126") [ M.SAssign "_127" (M.ELt (M.EVar "_27") (M.EVar "_5"));
      ...
      M.SAssign "_177" (M.EVar "SizeOf(f32)");
      M.SAssign "_178" (M.EVar "Ne(copy _177, const 0_usize)");
      ...
      M.SAssign "_139" (M.EVar "AlignOf(f32)");
      ...
      M.SAssign "_184" (M.EVar "SizeOf(f32)");
      M.SAssign "_185" (M.EVar "Ne(copy _184, const 0_usize)");
